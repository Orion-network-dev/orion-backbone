...
type Registry_SubscribeToStreamClient interface {
	Send(*PeersToServer) error
	Recv() (*ServerToPeers, error)
	grpc.ClientStream
}
...
func (x *registrySubscribeToStreamClient) Send(m *PeersToServer) error {
	return x.ClientStream.SendMsg(m)
}

func (x *registrySubscribeToStreamClient) Recv() (*ServerToPeers, error) {
	m := new(ServerToPeers)
...
type Registry_SubscribeToStreamServer interface {
	Send(*ServerToPeers) error
	Recv() (*PeersToServer, error)
	grpc.ServerStream
}
...
func (x *registrySubscribeToStreamServer) Send(m *ServerToPeers) error {
	return x.ServerStream.SendMsg(m)
}

func (x *registrySubscribeToStreamServer) Recv() (*PeersToServer, error) {
	m := new(PeersToServer)
